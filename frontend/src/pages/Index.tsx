...
const Index = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-background via-background/95 to-background overflow-hidden">
        ...
        >
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-12 max-w-2xl mx-auto">
              Streamline your quality assurance workflows with intelligent test automation, 
              bug analysis, and seamless integrations - all in your browser.
            </p>
          </motion.div>
          ...
          >
            ...
            <Button size="lg" variant="outline" className="border-border text-foreground hover:bg-accent px-8 py-4 text-lg">
              View Features
            </Button>
          </motion.div>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              No registration required. Access all our AI-powered QA tools directly in your browser
            </p>
          </motion.div>

          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <div className="relative mb-8">
              <TabsList className="grid w-full grid-cols-3 lg:grid-cols-6 bg-muted/50 p-1 rounded-lg relative overflow-hidden">
